...
public class User
{
    ...
    [MaxLength(50, ErrorMessage = "La constraseña no debe de tener mas de 50 caracteres")]
    [MinLength(8, ErrorMessage = "La constaseña debe de tener al menos 8 caracteres")]
